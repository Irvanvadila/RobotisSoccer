...
class DeteksiTiang:
    ...
    def __init__(self):
        ...
        if rospy.has_param("/tiang_h_low"):
            ...
            hsvLower = (rospy.get_param("/tiang_h_low"), rospy.get_param("/tiang_s_low"), rospy.get_param("/tiang_v_low"))
            hsvUpper = ( rospy.get_param("/tiang_h_up"), rospy.get_param("/tiang_s_up"), rospy.get_param("/tiang_v_up"))

        else:

            hsvLower = (94, 255, 90)
            hsvUpper = (115, 255, 152)
    ...
    def callback(self, data):
        ...
        if rospy.has_param("/tiang_h_low"):
            ...
            hsvMsg.linear.y = 255
            hsvMsg.linear.z = 90
            hsvMsg.angular.x = 155
            hsvMsg.angular.y = 255
            hsvMsg.angular.z = 152
