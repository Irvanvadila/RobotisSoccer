...
class Deteksibase:
    ...
    def __init__(self):
        ...
        if rospy.has_param("/base_h_low"):
            ...
            hsvLower = (rospy.get_param("/base_h_low"), rospy.get_param("/base_s_low"), rospy.get_param("/base_v_low"))
            hsvUpper = (rospy.get_param("/base_h_up"), rospy.get_param("/base_s_up"), rospy.get_param("/base_v_up"))
    ...
    def callback(self, data):
        ...
        output_blurred = cv2.GaussianBlur(frame, (9, 9), 0)
