...
def Walking(move_x, move_y, move_yaw, period):
    ...
    WalkingParam_msg.init_x_offset = -0.015 #depan #-0.015
    WalkingParam_msg.init_y_offset = 0.013 #samping #0.013
    WalkingParam_msg.init_z_offset = 0.035 #atas #0.035
    WalkingParam_msg.init_roll_offset = -0.001 #-0.001
    WalkingParam_msg.init_pitch_offset = -0.012 #-0.07
    WalkingParam_msg.init_yaw_offset = -0.001
    WalkingParam_msg.hip_pitch_offset = 0.013 #0.013
    WalkingParam_msg.period_time = period
    WalkingParam_msg.dsp_ratio = 0.25 #0.3
    WalkingParam_msg.step_fb_ratio = 0.3 #0.3
    ...
    WalkingParam_msg.balance_hip_roll_gain = 0.30 #30
    WalkingParam_msg.balance_knee_gain = 0.65 #65
    WalkingParam_msg.balance_ankle_roll_gain = 1.0 #1.0
    WalkingParam_msg.balance_ankle_pitch_gain = 0.0 #0.0
    WalkingParam_msg.y_swap_amplitude = 0.020
    WalkingParam_msg.z_swap_amplitude = 0.009
    WalkingParam_msg.arm_swing_gain = 0.25 #0.25
    WalkingParam_msg.pelvis_offset = 0.009 #0.009
